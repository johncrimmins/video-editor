/**
 * Timeline utility functions for timeline calculations and formatting
 */
 ...
 */
export const calculateClipWidth = (duration, totalDuration, timelineWidth) => {
 ...
 */
export const getDefaultTimelineDimensions = () => {
  const dimensions = {
    width: 800,
    height: 100
  };
